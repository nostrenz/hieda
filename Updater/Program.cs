...
namespace Updater
{
	class Program
	{
		...
		/// <summary>
		/// Verify that Hieda.exe isn't running.
		/// Kill it if needed.
		/// </summary>
		private void CheckHiedaExe()
		{
		...
		/// <summary>
		/// Replace Hieda files by the extracted files.
		/// </summary>
